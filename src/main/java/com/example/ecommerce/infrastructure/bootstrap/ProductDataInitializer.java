...
public class ProductDataInitializer {
    ...
    public void initializeProducts() {
        if (productRepository.count() == 0) {
            ...
            Product vinapner = new Product();
            vinapner.setName("Vinåpner");
            vinapner.setDescription("Klassisk vinåpner av høy kvalitet");
            vinapner.setPrice(new BigDecimal("19.99"));
            vinapner.setImageUrl("/images/wine opener.jpg");
            vinapner.setCategory("Mat og drikke");
            vinapner.setStockQuantity(12);
            ...
            productRepository.save(vinapner);
